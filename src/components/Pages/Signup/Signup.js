...
export default class Signup extends Component{
    ...
    constructor() {
        ...
        this.state={
            ...
            welcomemodal:false,
            servicemodal:false,
            userpolicymodal:false,
            isLoading:false
        };
        this.handleSubmit = this.handleSubmit.bind(this);
        this.handleChangeCheck= this.handleChangeCheck.bind(this);
       // this.toggle = this.toggle.bind(this);
        this.serviceModalToggle= this.serviceModalToggle.bind(this);
        this.emailModalToggle= this.emailModalToggle.bind(this);
        this.welcomeModalToggle= this.welcomeModalToggle.bind(this);
      ...
      handleClickUP= (e)=>{
        this.setState(prevState => ({
            userpolicymodal: !prevState.userpolicymodal
        }));
      }
        ...
        fetch(properties.userserviceurl+'/api/auth/authcheck', {
            ...
            body:  JSON.stringify(data)
              ...
              return response.json();
                ...
                console.log(error);
                log.error("api/auth/authcheck service is down");
                this.setState({isLoading:false});
                this.setState(prevState =>({ servicemodal:!prevState.servicemodal}));
    ...
    render(){
        return(   
            <div className="container p-t-100  p-b-100">
                            ...
                            <div className="col-md-12 col-xs-12">
                                ...
                                <form onSubmit={this.handleSubmit}>
                                    <div className="control">
                                        ...
                                        <input id="email" name="email" type="email" onBlur={this.handleChangeCheck}/>
                                    </div>
                                    ...
                                    <div className="control">
                                    <div className="font-75 font-regular align-left text-left">Please confirm the<a href="#" onClick={()=>{this.handleClickUP()}}>User Policy</a></div>
                                    </div>
                                    <div align="center">
                ...
                {/*MODEL - EMAIL EXIST*/}
                <Modal isOpen={this.state.emailmodal} toggle={this.emailModalToggle} className={this.props.className}>
                    <ModalHeader toggle={this.emailModalToggle}>Evntxz- User Exist</ModalHeader>
                    <ModalBody>
                 ...
                 {/*MODEL - EMAIL EXIST*/}
                 <Modal isOpen={this.state.welcomemodal} toggle={this.toggle} className={this.props.className}>
                 ...
                 <Modal isOpen={this.state.servicemodal} toggle={this.serviceModalToggle}  className={this.props.className}>
                    <ModalHeader toggle={this.serviceModalToggle}>Evntxz- User Service UNAVAILABLE</ModalHeader>
                    <ModalBody>
                        Error!!!! Service is unavailable, the system admin has been informed.
                    </ModalBody>
                </Modal>


                  {/*MODEL - SERVICE UNAVAILABLE*/}
                  <Modal isOpen={this.state.userpolicymodal} toggle={this.handleClickUP}  className={this.props.className}>
                    <ModalHeader toggle={this.handleClickUP}>Evntxz- Terms & Conditions</ModalHeader>
                    <ModalBody>
                    This website and any mobile application (collectively, this "Site") is owned by EVNTXZ ("We", "Us" or "EVNTXZ We are providing you with access to this Site and our online store (together, our "Services") subject to the following terms and conditions. By browsing, accessing, 
                    using, registering for or purchasing merchandise on this Site or otherwise using our Services, you are agreeing to all of the following terms and conditions, including any policies referred to herein (collectively, these "Terms"). So, please read these Terms carefully. 
                    We reserve the right to change this Site and these Terms at any time. If you are unwilling to be bound by these Terms, you should not browse, access, use, register for or purchase merchandise from the Site. You represent and warrant that you are at least 18 years old or 
                    ...
                    Use of This Site< br />
                    Subject to your compliance with these Terms, We grant you a limited, non-exclusive, non-transferable, non-sublicensable license to access and make personal, non-commercial use of this Site. This license grant does not include: (a) any resale or commercial use of this Site 
                    or content therein; (b) the collection and use of any product listings or descriptions; (c) making derivative uses of this Site and its contents; or (d) use of any data mining, robots, or similar data gathering and extraction methods on this Site. You may not use, frame or 
                    utilize framing techniques to enclose any of Our trademark, logo, content or other proprietary information (including the images found at this Site, the content of any text or the layout/design of any page or form contained on a page) without Our express written consent. 
                    Further, you may not use any meta tags or any other "hidden text" utilizing Our name, trademark, or product name without Our express written consent. Any breach of these Terms shall result in the immediate revocation of the license granted in this paragraph without notice to 
                    you. You are granted a limited, revocable, and nonexclusive right to create a hyperlink to the homepage of this Site so long as the link does not portray Us or Our products or services in a false, misleading, derogatory, or otherwise offensive matter. This limited right may be 
                    revoked at any time. You may not use any of Our logos or other proprietary graphics or trademarks as part of the link without express written permission.
                    <p />
                    
                    Account< br />
                    In order to access some features of this Site, you may be required to register and We may assign to you, or you may be required to select, a password and user name or account identification. If you register, you agree to provide Us with accurate and complete registration 
                    information, and to inform us immediately of any updates or other changes to such information. You are solely responsible for protecting the security and confidentiality of the password and identification assigned to you. You shall immediately notify Us of any unauthorized 
                    use of your password or identification or any other breach or threatened breach of this Site's security. Each time you use a password or identification, you will be deemed to be authorized to access and use the Site in a manner consistent with these Terms, and We have no obligation 
                    to investigate the authorization or source of any such access or use of this Site. YOU WILL BE SOLELY RESPONSIBLE FOR ALL ACCESS TO AND USE OF THIS SITE BY ANYONE USING THE PASSWORD AND IDENTIFICATION ORIGINALLY SELECTED BY, OR ASSIGNED TO, YOU WHETHER OR NOT SUCH ACCESS TO AND 
                    USE OF THIS SITE IS ACTUALLY AUTHORIZED BY YOU, INCLUDING WITHOUT LIMITATION, ALL COMMUNICATIONS AND TRANSMISSIONS AND ALL OBLIGATIONS (INCLUDING WITHOUT LIMITATION FINANCIAL OBLIGATIONS) INCURRED THROUGH SUCH ACCESS OR USE.
                    <p />
                    
                    Electronic Communication< br />
                    When you use this Site, or send emails to Us, you are communicating with Us electronically. You consent to receive communications from Us electronically. We will communicate with you by e-mail or by posting notices on this Site or through our other services. 
                    ...
                    User Content< br />
                    This Site may include features and functionality ("Interactive Features") that allows users to create, post, transmit or store any content, such as text, music, sound, photos, video, graphics or code on the Sites ("User Content"). User Content is publicly-viewable and may 
                    include your profile information and any content you post pursuant to your profile, but it does not include your account information or information you submit in order to make a purchase. You agree that you are solely responsible for your User Content and for your use of 
                    Interactive Features, and that your use any Interactive Features at your own risk. By using any Interactive Areas, you agree not to post, upload to, transmit, distribute, store, create or otherwise publish or send through the Sites any of the following: < br />< br />
                        -User Content that is unlawful, libelous, defamatory, obscene, pornographic, indecent, lewd, suggestive, harassing, threatening, abusive, inflammatory, fraudulent or otherwise objectionable;< br />< br />
                        -User Content that would constitute, encourage or provide instructions for a criminal offense, violate the rights of any party or that would otherwise create liability or violate any local, state, national or international law;< br />< br />
                        -User Content that displays, describes or encourages usage of any product We sell in a manner that could be offensive, inappropriate or harmful to Us or any user or consumer;< br />< br />
                        -User Content that may impinge upon or violate the publicity, privacy or data protection rights of others, including pictures, videos, images or information about another individual where you have not obtained such individual's consent;< br />< br />
                        -User Content that makes false or misleading statements, claims or depictions about a person, company, product or service;< br />< br />
                        -User Content that may infringe any patent, trademark, trade secret, copyright or other intellectual or proprietary right of any party;< br />< br />
                        -User Content that impersonates any person or entity or otherwise misrepresents your affiliation with a person or entity; and< br />< br />
                        -Viruses, malware of any kind, corrupted data or other harmful, disruptive or destructive files or code.< br />< br />
                        <p />
                        
                    Rights in User Content< br />
                    Except as otherwise provided in these Terms, on this Site or in a separate agreement with Us, We claim no ownership or control over any User Content. However, by submitting or posting User Content on this Site, you grant to Us a nonexclusive, royalty-free, worldwide, 
                    perpetual, irrevocable, transferable, and fully sublicensable right to use, reproduce, modify, adapt, publish, translate, create derivative works from, distribute, perform and display such User Content on this Site and on third-party sites and mobile applications and in 
                    all other media or formats, whether currently known or hereafter developed, for any purpose and without any compensation to you. You also grant users of this Site the right to access your User Content in connection with their use of this Site. By posting User Content to this 
                    Site, you represent and warrant that (a) such User Content is non-confidential; (b) you own and control all of the rights, title and interest in and to the User Content or you otherwise have all necessary rights to post and use such User Content to this Site and to grant to Us 
                    the rights that you grant in these Terms; (c) the User Content is accurate and not misleading or harmful in any manner; and (d) the User Content, and your use and posting thereof in connection with this Site, do not and will not violate these Terms or any other of Our applicable 
                    terms, guidelines or policies or any applicable law, rule or regulation.
                    <p />
                    
                    Feedback< br />
                    Separate and apart from User Content, you may have the ability to submit questions, comments suggestions, reviews, ideas, plans, designs, notes, proposals, drawings, original or creative materials and other information regarding this Site, Us and our products or services 
                    (collectively "Feedback"). You agree that Feedback is non-confidential and shall become Our sole property. We shall own exclusive rights, including all intellectual property rights, in and to such Feedback and shall be entitled to the unrestricted use and dissemination of the 
                    Feedback for any purpose, commercial or otherwise, without acknowledgment or compensation to you.
                    <p />
                    
                    Restrictions on Rights to Use< br />
...
Exclusivity of Remedy; Limitation of Liability< br />
...
Questions< br />
Questions regarding these Terms, Our Privacy Policy, or other policy related material can be directed to our support staff by emailing us at: [INSERT YOUR EMAIL ADDRESS].
<p />
                    </ModalBody>
                </Modal>
