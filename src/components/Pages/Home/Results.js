                ...
                <div className="col-md-3 col-sm-6 p-0 h-100">
                    <div className="product-grid ">
                        <div className="product-image">
                            <a href={"http://productservices.jx-staging.35.231.104.48.nip.io/productdetail/"+prod.iD}>
                                {
                        ...
                        <div className="product-content">
                            <h3 className="title"><a href={"http://productservices.jx-staging.35.231.104.48.nip.io/productdetail/"+prod.iD}>{prod.eventName}</a></h3>
                            <div className="price">{prod.eventPricing[0].ticketPricingCurrency} ${prod.eventPricing[0].ticketPricingAmount}.00
                                {/*<span>$20.00</span>*/}
                            </div>
                            <a className="add-to-cart" href={"http://productservices.jx-staging.35.231.104.48.nip.io/productdetail/"+prod.iD}>+ Add To Cart</a>
                        </div>
                    </div>
                </div>
                 )}
